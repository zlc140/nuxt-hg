<template>
  <div class="main" :style="{overflow: dialogVisiable? 'hidden': 'auto'}">
...
<style lang="less" scoped>
  ...
  .backgroundcard(@className,@pngName) {
    .list_@{className} {
      background: url("/img/clients/list_@{pngName}.png")no-repeat center 100%;
  ...
  .dalog-list{
    ...
    li{
      ...
      p{
        width: 100*164/1920vw;
        margin-left: 100*8/1920vw;
        height: 100*44/1920vw;
        position: absolute;
        bottom: 100*10/1920vw;
        font-size: 100*12/1920vw;
        color: #fff;
        text-align: center;
...
.client-wrap{
  ...
  &>div{
    ...
    .app-HQB{
      background-image: url("/img/clients/HQB-icon.png");
      background-size: 204px 186px;
    }
    .app-XXZH{
      background-image: url("/img/clients/XXZH.png");
      background-size: 90%;
    }
    .icon{
      margin: 0 auto 10px;
    ...
    .btn{
      ...
      .icon-qcode{
        display: inline-block;
        background: url("/img/clients/qcode-litter.png") no-repeat center center;
        width: 26px;
        height: 26px;
        margin-left: 25px;
      }
      .big-icon-qcode{
        ...
        height:441px;
        display: none;
        background:rgba(0,0,0,0.5) url("/img/clients/qcode-litter.png") no-repeat center center;
        border-radius:8px;
        position: absolute;
        top: 0;
        left: 0;
