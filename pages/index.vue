  ...
  <section class="main">
    ...
    <div class="main-container">
       <div class="company-introduce">
          <div class="btn-bg-blue">公司介绍1</div>
         <ul>
           ...
           <li><span>•</span>凭借行业领先的解决方案和稳健的经营理念，我们已经与多家银行、信托、消费金融公司以及知名互联网金融公司建立长期合作，共同推出了面向多种客群的金融服务方案。</li>
         </ul>
       </div>
...
.company-introduce{
  ...
  margin-right: 42px;
  height: 309px;
  background: url('~assets/img/index/introduce_bg.png') no-repeat 0 0;
  padding:35px 50px;
  ul{
    padding-top: 15px;
    text-align: justify;
...
.company-concat {
  ...
  height:310px;
  padding: 20px;
  background: url('~assets/img/index/mobile_bg.png') no-repeat 0 0;
  span{
    width:200px;
    height:36px;
    font-size:32px;
